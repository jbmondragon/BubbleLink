<x-app-layout>
    ...
    <div class="py-10">
        <div class="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
            <section class="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200" x-data="{ selectedPrice: '{{ $services->first()?->price ?? '0.00' }}' }">
                <form method="POST" action="{{ route('customer.orders.store', $shop) }}" class="space-y-6">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <input id="weight" name="weight" type="number" min="0.01" step="0.01" value="{{ old('weight') }}" class="mt-2 w-full rounded-2xl border-slate-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500" required>
                            @error('weight', 'customerOrderCreate')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <select id="service_mode" name="service_mode" class="mt-2 w-full rounded-2xl border-slate-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500" required>
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <input id="pickup_address" name="pickup_address" type="text" value="{{ old('pickup_address') }}" class="mt-2 w-full rounded-2xl border-slate-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
                        ...
                        <div>
                            ...
                            <input id="delivery_address" name="delivery_address" type="text" value="{{ old('delivery_address') }}" class="mt-2 w-full rounded-2xl border-slate-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <input id="pickup_datetime" name="pickup_datetime" type="datetime-local" value="{{ old('pickup_datetime') }}" class="mt-2 w-full rounded-2xl border-slate-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
                        ...
                        <div>
                            ...
                            <input id="delivery_datetime" name="delivery_datetime" type="datetime-local" value="{{ old('delivery_datetime') }}" class="mt-2 w-full rounded-2xl border-slate-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
