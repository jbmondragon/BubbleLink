...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        \DB::table('users')->insert([
            ['id' => 1, 'name' => 'John Doe', 'email' => 'john@example.com', 'email_verified_at' => now(), 'password' => bcrypt('password'), 'remember_token' => Str::random(10), 'contact_number' => '09170000001', 'created_at' => now()],
            ['id' => 2, 'name' => 'Alice Manager', 'email' => 'alice@example.com', 'email_verified_at' => now(), 'password' => bcrypt('password'), 'remember_token' => Str::random(10), 'contact_number' => '09170000002', 'created_at' => now()],
            ['id' => 3, 'name' => 'Bob Customer', 'email' => 'bob@example.com', 'email_verified_at' => now(), 'password' => bcrypt('password'), 'remember_token' => Str::random(10), 'contact_number' => '09170000003', 'created_at' => now()],
            ['id' => 4, 'name' => 'Jane Owner', 'email' => 'jane@example.com', 'email_verified_at' => now(), 'password' => bcrypt('password'), 'remember_token' => Str::random(10), 'contact_number' => '09170000004', 'created_at' => now()],
            ['id' => 5, 'name' => 'Mark Staff', 'email' => 'mark@example.com', 'email_verified_at' => now(), 'password' => bcrypt('password'), 'remember_token' => Str::random(10), 'contact_number' => '09170000005', 'created_at' => now()],
            ['id' => 6, 'name' => 'Mia Customer', 'email' => 'mia@example.com', 'email_verified_at' => now(), 'password' => bcrypt('password'), 'remember_token' => Str::random(10), 'contact_number' => '09170000006', 'created_at' => now()],
        ]);
