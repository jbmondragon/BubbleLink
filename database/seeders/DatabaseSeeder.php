...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \DB::table('shops')->insert([
            ...
            ['id' => 2, 'owner_user_id' => 1, 'shop_name' => 'QuickClean Laundry', 'address' => 'Real St. Tacloban City', 'contact_number' => '0287001002', 'description' => 'Express laundry services with 2-hour turnaround time.', 'created_at' => now()],
            ['id' => 3, 'owner_user_id' => 1, 'shop_name' => 'EcoWash Center', 'address' => 'Justice Romualdez St. Tacloban City', 'contact_number' => '0287001003', 'description' => 'Eco-friendly laundry with organic detergents and gentle care.', 'created_at' => now()],
            ['id' => 4, 'owner_user_id' => 1, 'shop_name' => 'Sparkle Wash', 'address' => 'Magsaysay Blvd. Tacloban City', 'contact_number' => '0287001004', 'description' => 'Premium wash and fold service with fabric softener and fragrance options.', 'created_at' => now()],
            ['id' => 5, 'owner_user_id' => 1, 'shop_name' => '24/7 Laundry Hub', 'address' => 'Kanligue St. Tacloban City', 'contact_number' => '0287001005', 'description' => 'Round-the-clock laundry service perfect for shift workers and busy professionals.', 'created_at' => now()],
            ['id' => 6, 'owner_user_id' => 1, 'shop_name' => 'Fresh & Clean', 'address' => 'Paterno St. Tacloban City', 'contact_number' => '0287001006', 'description' => 'Family-oriented laundry service with special care for children\'s clothing.', 'created_at' => now()],
            ['id' => 7, 'owner_user_id' => 1, 'shop_name' => 'ProWash Services', 'address' => 'Capitol Site, Tacloban City', 'contact_number' => '0287001007', 'description' => 'Commercial-grade laundry for businesses and bulk orders.', 'created_at' => now()],
            ['id' => 8, 'owner_user_id' => 1, 'shop_name' => 'Gentle Touch Laundry', 'address' => 'T. Claudio St. Tacloban City', 'contact_number' => '0287001008', 'description' => 'Specialized care for delicate fabrics, silk, and expensive clothing.', 'created_at' => now()],
            ['id' => 9, 'owner_user_id' => 1, 'shop_name' => 'Budget Wash', 'address' => 'Abucay St. Tacloban City', 'contact_number' => '0287001009', 'description' => 'Affordable laundry solutions for students and budget-conscious customers.', 'created_at' => now()],
            ['id' => 10, 'owner_user_id' => 1, 'shop_name' => 'Royal Cleaners', 'address' => 'Cruz St. Tacloban City', 'contact_number' => '0287001010', 'description' => 'Luxury laundry service with premium detergents and white-glove handling.', 'created_at' => now()],
        ]);
