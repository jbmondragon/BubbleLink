...
/**
 * Implements SID8 for shop owners managing and updating orders.
 *
 * Responsibilities:
 * - List owner orders across one or more shops with filters and summary metrics
 * - Create owner-managed walk-in or delivery orders
 * - Update order status, payment status, and recorded weight
 */
